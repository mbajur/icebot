...
module Dry::Schema::Extensions
end
module Dry::Schema::Extensions::Hints
end
module Dry::Schema::Extensions::Hints::CompilerMethods
  def visit_and(node); end
end
module Dry::Schema::Extensions::Hints::MessageCompilerMethods
  def exclude?(messages, opts); end
  def filter(messages, opts); end
  def hints; end
  def hints?; end
  def initialize(*arg0, **arg1); end
  def message_type(options); end
  def visit_each(_node, _opts); end
  def visit_hint(node, opts); end
  def visit_predicate(node, opts); end
end
...
class Dry::Schema::Hint < Dry::Schema::Message
  def hint?; end
