...
module Dry::Types
  ...
  extend Anonymous_Dry_Core_Deprecations_Tagged_111
...
module Anonymous_Dry_Core_Deprecations_Tagged_111
end
...
class Dry::Types::Schema::Key
  ...
  def to_ast(meta: nil); end
  def try(input, &block); end
  extend Anonymous_Dry_Core_Deprecations_Tagged_128
  extend Dry::Core::Deprecations::Interface
...
module Anonymous_Dry_Core_Deprecations_Tagged_128
end
